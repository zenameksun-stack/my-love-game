...
if mode == "легенький уровень❤️":
    st.markdown("<h2>✨ Насколько хорошо ты помнишь наши моменты?</h2>", unsafe_allow_html=True)
...
# ==========================================
    ...
    st.markdown("<h2>✨ Уровень 2: Наши общие воспоминания 😘</h2>", unsafe_allow_html=True)
