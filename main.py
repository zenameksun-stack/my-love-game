            ...
            if a3 == "в Голливуд":
                ...
                if a4 == "канешна":
                    ...
                    try:
                        ...
                        st.image("photo1.jpg", caption="Наш первый уровень пройден 🥰")
                    st.info(
                        "Солнышко, поздравляю, ты прошел первый уровень! Переверни страницу — выбери 'средний уровень💘' в списке самого верха страницы! ❤️")
                elif a4 is not None:
            ...
            if b3 == "в кс":
                ...
                if b4 == "16.01.2026":
                    ...
                    try:
                        ...
                        st.image("photo2.jpg", caption="Мы становимся ещё ближе 🥰")
                    st.info(
                        "Зайка, умничка мояя, ты большой milestone💋 Теперь выбери 'сложний уровень💖' в списке самого верха страницы!")
                elif b4 is not None:
                    st.markdown('<div class="big-error">подумай еще😉😘</div>', unsafe_allow_html=True)
            elif b3 is not None:
                st.markdown('<div class="big-error">подумай еще😉😘</div>', unsafe_allow_html=True)
